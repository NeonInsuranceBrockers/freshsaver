...
export const BuildingLibraryIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M16 22h2c.5 0 1-.2 1.4-.6.4-.4.6-.9.6-1.4V7.5L14.5 2H6c-1.1 0-2 .9-2 2v18" />
    <path d="M14 2v6h6" />
    <path d="M12 18s-2-1.5-2-4 2-4 2-4" />
    <path d="M10 18s2-1.5 2-4-2-4-2-4" />
  </svg>
);
...
export const UserAwardIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
  ...
  >
    ...
    <path d="M12 17.5 5.5 21l1.5-7.3L2 9.2l7.5-1.1L12 1l2.5 7.1L22 9.2l-5 4.5L18.5 21Z" />
  </svg>
);