...
return (
  ...
  < div className = "pt-1" >
    ...
    >
      <span>Partners</span>
      <ChevronDownIcon
        className={`h-5 w-5 text-muted-foreground transition-transform ${isPartnersOpen ? 'rotate-180' : ''
          }`}
      />
    </button>
{
  ...
  < div className = "pt-1" >
    ...
    >
      <span>Company</span>
      <ChevronDownIcon
        className={`h-5 w-5 text-muted-foreground transition-transform ${isCompanyOpen ? 'rotate-180' : ''
          }`}
      />
    </button>
{
